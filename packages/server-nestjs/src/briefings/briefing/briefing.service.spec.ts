...
describe('BriefingService', () => {
  ...
  describe('generateBriefing', () => {
    beforeEach(() => {
      ...
      (conversationRepository.find as jest.Mock).mockResolvedValue(mockConversations); 
    ...
    it('should return the briefing generated by AiService', async () => {
  ...
  describe('refreshBriefing', () => {
    ...
    beforeEach(() => {
      ...
      generateBriefingSpy.mockResolvedValue('Refreshed briefing text');
    });
    ...
    it('should return the refreshed briefing', async () => {
      ...
      expect(refreshedBriefing).toEqual('Refreshed briefing text');
    });
  });
});