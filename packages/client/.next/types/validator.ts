...
// Validate ../../app/api/feishu/bitable/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/feishu/bitable">> = Specific
  const handler = {} as typeof import("../../app/api/feishu/bitable/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
